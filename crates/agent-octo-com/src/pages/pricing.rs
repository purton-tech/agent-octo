use daisy_rsx::{Badge, BadgeColor, BadgeStyle, Button, ButtonScheme, ButtonType};
use dioxus::prelude::*;
                    ...
                    div {
                        ...
                        div {
                            ...
                            SiteCard {
                                ...
                                body_class: Some("h-full gap-5".to_string()),
                                ...
                                div {
                                    ...
                                    h2 { class: "font-mono text-3xl font-bold tracking-tight", "Open source" }
                                    p {
                            ...
                            SiteCard {
                                class: Some("h-full border-primary/20".to_string()),
                                body_class: Some("h-full gap-5".to_string()),
                                interactive: Some(false),
                                div {
                                    class: "space-y-3",
                                    ...
                                    h2 { class: "font-mono text-3xl font-bold tracking-tight", "Hosted app, token-based billing" }
                                    p {
                                        class: "text-base-content/75",
                        ...
                        SiteCard {
                            class: Some("md:col-span-2".to_string()),
                            body_class: Some("gap-3".to_string()),
                            interactive: Some(false),
                            h2 { class: "font-mono text-2xl font-bold tracking-tight", "How usage is charged" }
                            p {
                                class: "text-base-content/75",
